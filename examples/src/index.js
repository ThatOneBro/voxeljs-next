...
import { initialize, Parent, Transform, Object3D } from "ecsy-three";
...
world.createEntity().addComponent(KeyboardBindingSet, {
  bindings: {
...
world
  ...
  .addComponent(VoxelLandscape, {
    make_voxel: (x, y, z) => {
      ...
      if (x > 0 && x < 5 && z > 5 && z < 10 && y > 5 && y < 10) return 2; // brick
      return 0;
    },
  })
...
world.createEntity().addComponent(MouseCursor);
